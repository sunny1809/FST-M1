...
public class Activity3 {
	...
	public void googleKeep2() {
		...
		driver.findElementById("editable_title").sendKeys("Proj Activity3");

		wait.until(ExpectedConditions.elementToBeClickable(By.id("edit_note_text")));
		driver.findElementById("edit_note_text").sendKeys("Google Keep Activity 2");

		wait.until(ExpectedConditions.elementToBeClickable(By.id("menu_reminder")));
		driver.findElementById("menu_reminder").click();

		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//android.view.ViewGroup[1]/android.widget.TextView[@text=\"Later today\"]")));
		...
		wait.until(ExpectedConditions.elementToBeClickable(
				By.xpath("//android.view.ViewGroup/android.widget.LinearLayout/android.widget.TextView[2]")));
		driver.findElementByXPath("//android.view.ViewGroup/android.widget.LinearLayout/android.widget.TextView[2]")
				.click();
		...
		Assert.assertEquals(msg, "Proj Activity3");
